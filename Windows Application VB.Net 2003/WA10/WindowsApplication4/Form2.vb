...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        '
        Me.dbg.DataMember = ""
        Me.dbg.DataSource = Me.Ds1.Employees
        ...
        Me.dbg.Name = "dbg"
        Me.dbg.Size = New System.Drawing.Size(488, 144)
        Me.dbg.TabIndex = 0
        '
        'Ds1
        '
        ...
        'Button3
        '
        Me.Button3.Location = New System.Drawing.Point(264, 232)
...
#End Region
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Me.BindingContext(Ds1, "employees").Position += 1
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        'MsgBox(dbg(dbg.CurrentRowIndex, 0) & vbCrLf & dbg(dbg.CurrentRowIndex, 1))
        Dim frm As New Form3
        frm.TextBox1.Text = dbg(dbg.CurrentRowIndex, 0)
        frm.TextBox2.Text = dbg(dbg.CurrentRowIndex, 1)
        frm.TextBox3.Text = dbg(dbg.CurrentRowIndex, 2)
        frm.Show()
    End Sub

    Private Sub dbg_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles dbg.Click

    End Sub

    Private Sub dbg_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles dbg.MouseUp
        Dim frm As New Form3
        frm.TextBox1.Text = dbg(dbg.CurrentRowIndex, 0)
        frm.TextBox2.Text = dbg(dbg.CurrentRowIndex, 1)
        frm.TextBox3.Text = dbg(dbg.CurrentRowIndex, 2)
