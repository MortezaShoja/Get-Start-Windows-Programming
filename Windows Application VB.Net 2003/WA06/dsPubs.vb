...
Public Class dsPubs
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As dsPubs = CType(MyBase.Clone,dsPubs)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "dsPubs"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/dsPubs.xsd"
    ...
    Public Class authorsDataTable
        ...
        Public Overloads Function AddauthorsRow(ByVal au_id As String, ByVal au_lname As String, ByVal au_fname As String, ByVal phone As String) As authorsRow
            Dim rowauthorsRow As authorsRow = CType(Me.NewRow,authorsRow)
            rowauthorsRow.ItemArray = New Object() {au_id, au_lname, au_fname, phone}
