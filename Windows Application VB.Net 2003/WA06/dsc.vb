...
Public Class dsc
    ...
    Public Class jobsDataTable
        ...
        Public Overloads Function AddjobsRow(ByVal job_desc As String, ByVal min_lvl As Byte) As jobsRow
            Dim rowjobsRow As jobsRow = CType(Me.NewRow,jobsRow)
            rowjobsRow.ItemArray = New Object() {Nothing, job_desc, min_lvl}
