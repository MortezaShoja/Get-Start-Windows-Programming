...
Public Class dsNew1
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As dsNew1 = CType(MyBase.Clone,dsNew1)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "dsNew1"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/dsNew1.xsd"
    ...
    Public Class employeeDataTable
        ...
        Private columnشناسه As DataColumn
        
        Private columnنام As DataColumn
        
        Private columnفامیلی As DataColumn
        ...
        Friend ReadOnly Property شناسهColumn As DataColumn
            Get
                Return Me.columnشناسه
            End Get
        End Property
        
        Friend ReadOnly Property نامColumn As DataColumn
            Get
                Return Me.columnنام
            End Get
        End Property
        
        Friend ReadOnly Property فامیلیColumn As DataColumn
            Get
                Return Me.columnفامیلی
            End Get
        End Property
        ...
        Public Overloads Function AddemployeeRow(ByVal شناسه As String, ByVal نام As String, ByVal فامیلی As String) As employeeRow
            Dim rowemployeeRow As employeeRow = CType(Me.NewRow,employeeRow)
            rowemployeeRow.ItemArray = New Object() {شناسه, نام, فامیلی}
            Me.Rows.Add(rowemployeeRow)
            Return rowemployeeRow
        End Function
        
        Public Function FindByشناسه(ByVal شناسه As String) As employeeRow
            Return CType(Me.Rows.Find(New Object() {شناسه}),employeeRow)
        End Function
        ...
        Friend Sub InitVars()
            Me.columnشناسه = Me.Columns("شناسه")
            Me.columnنام = Me.Columns("نام")
            Me.columnفامیلی = Me.Columns("فامیلی")
        End Sub
        
        Private Sub InitClass()
            Me.columnشناسه = New DataColumn("شناسه", GetType(System.String), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnشناسه)
            Me.columnنام = New DataColumn("نام", GetType(System.String), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnنام)
            Me.columnفامیلی = New DataColumn("فامیلی", GetType(System.String), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnفامیلی)
            Me.Constraints.Add(New UniqueConstraint("Constraint1", New DataColumn() {Me.columnشناسه}, true))
            Me.columnشناسه.AllowDBNull = false
            Me.columnشناسه.Unique = true
            Me.columnنام.AllowDBNull = false
            Me.columnفامیلی.AllowDBNull = false
        End Sub
    ...
    Public Class employeeRow
        ...
        Public Property شناسه As String
            Get
                Return CType(Me(Me.tableemployee.شناسهColumn),String)
            End Get
            Set
                Me(Me.tableemployee.شناسهColumn) = value
            End Set
        End Property
        
        Public Property نام As String
            Get
                Return CType(Me(Me.tableemployee.نامColumn),String)
            End Get
            Set
                Me(Me.tableemployee.نامColumn) = value
            End Set
        End Property
        
        Public Property فامیلی As String
            Get
                Return CType(Me(Me.tableemployee.فامیلیColumn),String)
            End Get
            Set
                Me(Me.tableemployee.فامیلیColumn) = value
            End Set
        End Property
    End Class
