...
Public Class dsPubs
    ...
    Public Class employeeDataTable
        ...
        Public Overloads Function AddemployeeRow(ByVal emp_id As String, ByVal fname As String, ByVal lname As String) As employeeRow
            Dim rowemployeeRow As employeeRow = CType(Me.NewRow,employeeRow)
            rowemployeeRow.ItemArray = New Object() {emp_id, fname, lname}
